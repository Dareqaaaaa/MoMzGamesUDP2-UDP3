...
<style type="text/css">
	...
	#launcherwap {background:url(images/launcher.gif) no-repeat; width:842px; height:431px; overflow:hidden;}
	...
	#launcherwap .bbsL {margin: auto auto auto 150px; float:left; width:421px; height:24px; padding:0 0 0 7px;font-size:12px; color:#ffffff; }
